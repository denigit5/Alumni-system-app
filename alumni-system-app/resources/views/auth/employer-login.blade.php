...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('employer-login') }}">
            ...
            <div class="message">
                <p>Don't have an account? <a href="{{ route('employer-register') }}" class="underline text-gray-600 hover:text-gray-900">Create one here</a></p>
            </div>

            <div class="flex items-center justify-end">
                <a href="{{ route('employer-register') }}" class="register-button">Register</a>
            </div>
