...
<head>
    ...
    <style>
        body {
            background-color: #2E2E2E; /* darkgrey background */
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('alumni-login') }}">
            <h2 style="text-align: center; color:#f04037;">Alumni login</h2>
            @csrf
            ...
            <div class="message">
                <p>Don't have an account? <a href="{{ route('alumni-register') }}" class="underline text-gray-600 hover:text-gray-900">Create one here</a></p>
            </div>

            <div class="flex items-center justify-end">
                <a href="{{ route('alumni-register') }}" class="register-button">Register</a>
            </div>
